...
The simplest usage of [donghyunlee022/webhook](https://hub.docker.com/repository/docker/donghyunlee022/webhook) image is for one to host the hooks JSON file on their machine and mount the directory in which those are kept as a volume to the Docker container:
